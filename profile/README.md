...
| Repo | What it is |
|---|---|
| [`soroban-by-example`](https://github.com/daccred/soroban-by-example) | AI-assisted Soroban learning resource (archived) |
| [`abi-to-mcp`](https://github.com/daccred/abi-to-mcp) | Generate MCP servers from any EVM contract ABI |
